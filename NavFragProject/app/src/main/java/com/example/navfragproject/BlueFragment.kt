...
class BlueFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var bt=view.findViewById<TextView>(R.id.bluetextview)
        var bt2=view.findViewById<TextView>(R.id.bluetextView2)

        var d1=arguments?.getString("key1")
        var d2=arguments?.getString("key2")
        bt.setText(d1)
        bt2.setText(d2)
        return view
    }
